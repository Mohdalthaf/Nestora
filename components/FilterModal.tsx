...
import {
  ...
  const chipText = (active: boolean) =>
    `text-sm font-semibold ${
      active ? "text-white" : "text-gray-600 dark:text-neutral-300"
    }`;
    ...
    return (
      ...
      >
        <View className="flex-1 bg-gray-50 dark:bg-neutral-950">
          {/* Header */}
          <View className="flex-row items-center justify-between px-5 pt-6 pb-4 bg-white dark:bg-neutral-900 border-b border-gray-100 dark:border-neutral-800">
          ...
          >
            {/* Property Type */}
            <Text className="text-base font-bold text-gray-800 dark:text-neutral-100 mb-3">
              Property Type
            </Text>
            ...
            <View className="flex-row gap-3 mb-3">
              {[
                ...
                <View key={label} className="flex-1">
                  <Text className="text-xs text-gray-500 dark:text-neutral-400 mb-1.5 font-medium">
                    {label}
                  </Text>
                  <View
                    className="flex-row items-center bg-white dark:bg-neutral-900 rounded-2xl px-3 border border-gray-200 dark:border-neutral-700"
                    style={shadow}
                  >
                    <Text className="text-gray-400 dark:text-neutral-500 text-sm mr-1">
                      ₹
                    </Text>
                    <TextInput
          ...
          {/* Apply Button */}
          <View className="px-5 pb-8 pt-4 bg-white dark:bg-neutral-900 border-t border-gray-100 dark:border-neutral-800">
            <TouchableOpacity
              onPress={handleApply}
