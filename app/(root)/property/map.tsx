...
export default function MapScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white dark:bg-neutral-950">
      {/* Header */}
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-neutral-800 bg-white dark:bg-neutral-900">
        <TouchableOpacity
          onPress={() => router.back()}
        ...
        <View className="flex-1 mx-3">
          ...
          <Text className="text-gray-400 dark:text-neutral-500 text-xs" numberOfLines={1}>
            {address}
          </Text>
        </View>
        ...
        <TouchableOpacity
          ...
          className="flex-row items-center gap-1 bg-blue-50 dark:bg-blue-950/40 px-3 py-2 rounded-full"
        >
